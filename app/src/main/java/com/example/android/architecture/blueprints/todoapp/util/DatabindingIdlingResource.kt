...
class DatabindingIdlingResource: IdlingResource {
    ...
    /** Override method from IdlingResource
     *
     * The IdlingResource class Represents a resource of an application under test which can cause asynchronous background work
     ...
     */
    override fun getName() = "Databinding_$id"
